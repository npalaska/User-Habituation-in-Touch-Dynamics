...
while user <= 31:
    ...
    path = parentdirectory + '/Output Files/Experiment73/GIUser/User' + str(
        user)
        ...
        while folds <= 10:
            ...
            while 23 <= imposture <= 31:
                ...
                if imposture != user:
                    ...
                    arr_imposture_train = arr_imposture_train[:, :]
                    arr_imposture_test = arr_imposture_test[:, :]
            ...
            # save the files.
            np.savetxt("../../Output Files/Experiment73/GIUser/User" + str(
