...
path = parentdirectory + '\Output Files\Experiment70\Support Vector Machine\ROC Characteristics SVM'
...
while user <= 31:
    while block <= 3:
        while fold <= 10:
            ...
            clf = svm.SVC(kernel='linear', C=1)  # Classifier with Scaled data
            ...
            np.savetxt(
                "../../Output Files/Experiment70/Support Vector Machine/ROC Characteristics SVM/1-" + str(
...
np.savetxt(
    "../../Output Files/Experiment70/Support Vector Machine/SVM_EER.csv",
    eervalues, delimiter=",")

aucvalues = np.transpose(arr_auc.reshape(93, 10))
np.savetxt(
    "../../Output Files/Experiment70/Support Vector Machine/SVM_Auc.csv",
    aucvalues, delimiter=",")
...
np.savetxt(
    "../../Output Files/Experiment70/Support Vector Machine/SVM_MeanEER.csv",
    arr_eer.reshape(31, 3), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment70/Support Vector Machine/SVM_MeanAuc.csv",
