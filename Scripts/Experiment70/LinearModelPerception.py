...
path = parentdirectory + '\Output Files\Experiment70\Linear Model-Perceptron\ROC Characteristics Perceptron'
...
while user <= 31:
    while block <= 3:
        while fold <= 10:
            ...
            np.savetxt(
                "../../Output Files/Experiment70/Linear Model-Perceptron/ROC Characteristics Perceptron/1-" + str(
...
np.savetxt(
    "../../Output Files/Experiment70/Linear Model-Perceptron/PerceptronScaled_EER.csv",
    eervalues, delimiter=",")

aucvalues = np.transpose(arr_auc.reshape(93, 10))
np.savetxt(
    "../../Output Files/Experiment70/Linear Model-Perceptron/PerceptronScaled_AUC.csv",
    aucvalues, delimiter=",")
...
np.savetxt(
    "../../Output Files/Experiment70/Linear Model-Perceptron/PerceptronScaled_MeanEER.csv",
    arr_eer.reshape(31, 3), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment70/Linear Model-Perceptron/PerceptronScaled_MeanAUC.csv",
