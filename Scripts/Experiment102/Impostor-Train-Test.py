...
path = parentdirectory + '\Output Files\Experiment102\Impostor User'
...
while folds <= 10:
    while user <= 31:
        ...
        lengthofimpostor = 10  # length of an imposture data from every other user
        randomsample = random.sample(lines,
                                     lengthofimpostor)  # get the 5 random strokes from every genuine user

        with open("../../Output Files/Experiment102/Impostor User/1-" + str(
