...
while user <= 31:
    ...
    path = parentdirectory + '/Output Files/Experiment102/GIUser/User' + str(
        user)
    ...
    while blocks <= 3:
        ...
        while folds <= 10:
            while imposture <= 31:
                ...
                if imposture != user:
                    arr_imposture_train = genfromtxt(
                        '../../Output Files/Experiment102/Impostor User/1-' + str(
            ...
            # save the files.
            np.savetxt("../../Output Files/Experiment102/GIUser/User" + str(
