...
path = parentdirectory + '\Output Files\Experiment90\Random Forest-Half Split\ROC Characteristics Random Forest'
...
arr_auc_scaled = arange(620, dtype=float32).reshape(620, 1)
arr_auc = arange(620, dtype=float32).reshape(620, 1)
arr_eer = arange(620, dtype=float32).reshape(620, 1)
    ...
    while block <= 2:
        while fold <= 10:
            ...
            traindata = genfromtxt(
                '../../Output Files/Experiment71/GIUser/User' + str(
            ...
            np.savetxt(
                "../../Output Files/Experiment90/Random Forest-Half Split/ROC Characteristics Random Forest/1-" + str(
...
eervalues = np.transpose(arr_eer.reshape(62, 10))
np.savetxt(
    "../../Output Files/Experiment90/Random Forest-Half Split/RandomForestScaled_EER.csv",
    eervalues, delimiter=",")

aucvalues = np.transpose(arr_auc_scaled.reshape(62, 10))
np.savetxt(
    "../../Output Files/Experiment90/Random Forest-Half Split/RandomForestScaled_AUC.csv",
    aucvalues, delimiter=",")
aucvalues = np.transpose(arr_auc.reshape(62, 10))
np.savetxt(
    "../../Output Files/Experiment90/Random Forest-Half Split/RandomForest_AUC.csv",
    aucvalues, delimiter=",")

eerpreprocessdata = genfromtxt(
    '../../Output Files/Experiment90/Random Forest-Half Split/RandomForestScaled_EER.csv',
    dtype=float, delimiter=',')
arr_eer = arange(62, dtype=float32).reshape(62, 1)

aucscaleddata = genfromtxt(
    '../../Output Files/Experiment90/Random Forest-Half Split/RandomForestScaled_AUC.csv',
    dtype=float, delimiter=',')
arr_auc_scaled = arange(62, dtype=float32).reshape(62, 1)
aucdata = genfromtxt(
    '../../Output Files/Experiment90/Random Forest-Half Split/RandomForest_AUC.csv',
    dtype=float, delimiter=',')
arr_auc = arange(62, dtype=float32).reshape(62, 1)
...
np.savetxt(
    "../../Output Files/Experiment90/Random Forest-Half Split/RandomForestScaled_MeanEER.csv",
    arr_eer.reshape(31, 2), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment90/Random Forest-Half Split/RandomForestScaled_MeanAUC.csv",
    arr_auc_scaled.reshape(31, 2), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment90/Random Forest-Half Split/RandomForest_MeanAUC.csv",
    arr_auc.reshape(31, 2), delimiter=",")