...
path = parentdirectory + '\Output Files\Experiment91\Random Forest-6Split\ROC Characteristics Random Forest'
...
arr_auc_scaled = arange(1860, dtype=float32).reshape(1860, 1)
    ...
    while block <= 6:
        while fold <= 10:
            ...
            traindata = genfromtxt(
                '../../Output Files/Experiment72/GIUser/User' + str(
            ...
            np.savetxt(
                "../../Output Files/Experiment91/Random Forest-6Split/ROC Characteristics Random Forest/1-" + str(
...
eervalues = np.transpose(arr_eer.reshape(186, 10))
np.savetxt(
    "../../Output Files/Experiment91/Random Forest-6Split/RandomForestScaled_EER.csv",
    eervalues, delimiter=",")

aucvalues = np.transpose(arr_auc_scaled.reshape(186, 10))
np.savetxt(
    "../../Output Files/Experiment91/Random Forest-6Split/RandomForestScaled_AUC.csv",
    aucvalues, delimiter=",")
aucvalues = np.transpose(arr_auc.reshape(186, 10))
np.savetxt(
    "../../Output Files/Experiment91/Random Forest-6Split/RandomForest_AUC.csv",
    aucvalues, delimiter=",")
...
aucscaleddata = genfromtxt(
    '../../Output Files/Experiment91/Random Forest-6Split/RandomForestScaled_AUC.csv',
    dtype=float, delimiter=',')
arr_auc_scaled = arange(186, dtype=float32).reshape(186, 1)
aucdata = genfromtxt(
    '../../Output Files/Experiment91/Random Forest-6Split/RandomForest_AUC.csv',
    dtype=float, delimiter=',')
...
np.savetxt(
    "../../Output Files/Experiment91/Random Forest-6Split/RandomForestScaled_MeanEER.csv",
    arr_eer.reshape(31, 6), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment91/Random Forest-6Split/RandomForestScaled_MeanAUC.csv",
    arr_auc_scaled.reshape(31, 6), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment91/Random Forest-6Split/RandomForest_MeanAUC.csv",
    arr_auc.reshape(31, 6), delimiter=",")