...
path = parentdirectory + '\Output Files\Experiment91\Linear Model-Perceptron-6Split\ROC Characteristics Perceptron'
...
while user <= 31:
    while block <= 6:
        while fold <= 10:
            ...
            np.savetxt(
                "../../Output Files/Experiment91/Linear Model-Perceptron-6Split/ROC Characteristics Perceptron/1-" + str(
...
np.savetxt(
    "../../Output Files/Experiment91/Linear Model-Perceptron-6Split/PerceptronScaled_EER.csv",
    eervalues, delimiter=",")

aucvalues = np.transpose(arr_auc.reshape(186, 10))
np.savetxt(
    "../../Output Files/Experiment91/Linear Model-Perceptron-6Split/PerceptronScaled_AUC.csv",
    aucvalues, delimiter=",")
...
np.savetxt(
    "../../Output Files/Experiment91/Linear Model-Perceptron-6Split/PerceptronScaled_MeanEER.csv",
    arr_eer.reshape(31, 6), delimiter=",")
np.savetxt(
    "../../Output Files/Experiment91/Linear Model-Perceptron-6Split/PerceptronScaled_MeanAUC.csv",
